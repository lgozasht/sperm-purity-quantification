...
configfile: "/global/scratch/users/landen_gozashti/projects/Sperm_diversity/methylation_purity/human/config/pipelineConfigs/template_config.yml"
...
rule all:
    input:
        ...
        "output/liftover/lifted_imprinted_regions.bed",
